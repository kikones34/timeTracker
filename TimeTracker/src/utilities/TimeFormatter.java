...
// Utility class which provides a simple interface to format time.
public final class TimeFormatter {
	...
	public static String formatFull(final long millis) {
		int[] periodDurations =
			{31536000, 2592000, 86400, 3600, 60, 1}; // in seconds
		String[] periodNames =
